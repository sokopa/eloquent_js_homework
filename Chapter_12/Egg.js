...
function parseApply(expr, program) {
  ...
  program = skipSpace(program.slice(1)); // remove ( from the start of the string
...
specialForms.while = (args, scope) => {
  ...
  return false; // Instead of undefined, for lack of anything else more meaningful
};
