...
// again with an optional sign in front of the exponent.
// Also note that it is not necessary for there to be digits
// in front of or after the dot, but the number cannot be a dot alone.
